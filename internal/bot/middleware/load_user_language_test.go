...
func (m *mockCore) Unsubscribe(ctx context.Context, userID int64, sourceID uint) error   { panic("not implemented") }
func (m *mockCore) GetSourceByURL(ctx context.Context, sourceURL string) (*model.Source, error) { panic("not implemented") }
...
func (m *mockCore) SetSubscriptionInterval(ctx context.Context, userID int64, sourceID uint, interval int) error { panic("not implemented") }
func (m *mockCore) EnableSourceUpdate(ctx context.Context, sourceID uint) error        { panic("not implemented") }
func (m *mockCore) DisableSourceUpdate(ctx context.Context, sourceID uint) error       { panic("not implemented") }
func (m *mockCore) ClearSourceErrorCount(ctx context.Context, sourceID uint) error     { panic("not implemented") }
func (m *mockCore) SourceErrorCountIncr(ctx context.Context, sourceID uint) error      { panic("not implemented") }
func (m *mockCore) ToggleSubscriptionNotice(ctx context.Context, userID int64, sourceID uint) error { panic("not implemented") }
func (m *mockCore) ToggleSourceUpdateStatus(ctx context.Context, sourceID uint) error  { panic("not implemented") }
func (m *mockCore) ToggleSubscriptionTelegraph(ctx context.Context, userID int64, sourceID uint) error { panic("not implemented") }
func (m *mockCore) GetSourceAllSubscriptions(ctx context.Context, sourceID uint) ([]*model.Subscribe, error) { panic("not implemented") }
func (m *mockCore) ContentHashIDExist(ctx context.Context, hashID string) (bool, error) { panic("not implemented") }
func (m *mockCore) SetUserLanguage(ctx context.Context, userID int64, langCode string) error { panic("not implemented") }
...
func TestLoadUserLanguage(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			mockCtx := newMockTelebotContext(tt.sender)
			nextCalled := false
...
func (m *mockTelebotContext) SendChatAction(action tb.ChatAction, opts ...interface{}) error { return nil }
...
func (m *mockTelebotContext) SendAlbumMenu(a tb.Album, menu *tb.ReplyMarkup, opts ...interface{}) error { return nil }
func (m *mockTelebotContext) SetChatID(chatID string)                                    {}
func (m *mockTelebotContext) ChatID() string                                             { if m.sender != nil { return strconv.FormatInt(m.sender.ID, 10) } ; return ""}
