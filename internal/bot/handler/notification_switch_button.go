...
func genFeedSetBtn(
	...
	setSubTagKey := tb.InlineButton{
		Unique: SetSubscriptionTagButtonUnique, // Assumes this constant is accessible or redefined
	...
	toggleTelegraphKey := tb.InlineButton{
		Unique: TelegraphSwitchButtonUnique, // Assumes this constant is accessible or redefined
	...
	toggleEnabledKey := tb.InlineButton{
		Unique: SubscriptionSwitchButtonUnique, // Assumes this constant is accessible or redefined
